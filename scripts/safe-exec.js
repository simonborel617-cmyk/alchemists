...
(async () => {
  ...
  // mainnet: the owners' keys SAFE_OWNER_1_KEY/SAFE_OWNER_2_KEY sign (the first pays the gas); testnet: the rehearsal keys
  ...
  const sender = signers[0]; // the first owner pays the gas: the keeper wallet stays with the keeper (no nonce clashes)
