...
for n in Mine Workshop Alchemists Kettle; do mkdir -p "$stage/artifacts/contracts/$n.sol"; cp "artifacts/contracts/$n.sol/$n.json" "$stage/artifacts/contracts/$n.sol/"; done
